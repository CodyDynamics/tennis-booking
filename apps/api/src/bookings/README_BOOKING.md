...
**API:**
- `POST /bookings/court` – create court booking (body: courtId, bookingDate, startTime, endTime, coachId?)
- `GET /bookings/court/availability?courtId=&date=&slotMinutes=` – get available slots by court and date.
